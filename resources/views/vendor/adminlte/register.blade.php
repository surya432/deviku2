...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form action="{{ url(config('adminlte.register_url', 'register')) }}" autocomplete="off" method="post">
            {!! csrf_field() !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('site') ? 'has-error' : '' }}">
                <input type="text" name="site" class="form-control" value="{{ old('site') }}" placeholder="WebSite">
